...
def addCoffeToDataBaseInterface():
    ...
    if addCoffeToDataBase(validBrenneriID,validEpostadresse, validBrenneriNavn, brenneristedInput, kaffenavn, poeng, smaksnotat):
